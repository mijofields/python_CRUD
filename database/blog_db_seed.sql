...
CREATE TABLE posts(
  ...
  userid INTEGER (10) NOT NULL REFERENCES users(userid),
  date TIMESTAMP,
  PRIMARY KEY (postid)
);
...
INSERT INTO posts (title, body, userid) values ("I'm full", "Mr. Creosote is a fictional character who appears in Monty Python's The Meaning of Life. 
...
INSERT INTO posts (title, body, userid) values ("He's not the messiah, he's a very naughty boy", "Brian Cohen is born in a stable next door to the one in which Jesus is born, which initially confuses the three wise men who come to praise the future King of the Jews. 
...
INSERT INTO posts (title, body, userid) values ("The Holy Grail Horses", "Originally the knight characters were going to ride real horses, but after it became clear that the film's small budget precluded real horses, 
...
INSERT INTO posts (title, body, userid) values ("The Knights Who Say Ni", "The knights demand a sacrifice, and when Arthur states that he merely wishes to pass through the woods, the knights begin shouting 'Ni!', 
...
INSERT INTO posts (title, body, userid) values ("And now for something completely different", "'The End of the Film' epilogue features the host of 'The Middle of the Film' being handed an envelope containing the meaning of life. 
...
INSERT INTO posts (title, body, userid) values ("You're all individuals!", "Jesus did, sir. I was hopping along, minding my own business, all of a sudden, up he comes, cures me! 
